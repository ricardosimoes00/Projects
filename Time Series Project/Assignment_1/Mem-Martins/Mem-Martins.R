...
setwd("C:/Users/Fernando/Desktop/ST/Mem-Martins")
data <- read_excel("C:/Users/Fernando/Desktop/ST/QualidadeARO3.xlsx")
Localidade <- data$`Mem-Martins`
...
Box.test(test2$residuals,lag=2, type="Ljung")
...
Box.test(test3$residuals,lag=2, type="Ljung")
...
Box.test(test4$residuals,lag=2, type="Ljung")
