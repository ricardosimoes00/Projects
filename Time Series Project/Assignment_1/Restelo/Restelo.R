...
setwd("C:/Users/Fernando/Desktop/ST/Restelo")
data <- read_excel("C:/Users/Fernando/Desktop/ST/QualidadeARO3.xlsx")
Localidade <- data$Restelo
...
Box.test(test2$residuals,lag=8, type="Ljung")
...
Box.test(test3$residuals,lag=8, type="Ljung")
...
Box.test(test4$residuals,lag=8, type="Ljung")
