...
setwd("C:/Users/Fernando/Desktop/ST/Paio-Pires")
data <- read_excel("C:/Users/Fernando/Desktop/ST/QualidadeARO3.xlsx")
Localidade <- data$`Paio-Pires`
...
Box.test(test2$residuals,lag=16, type="Ljung")
...
Box.test(test3$residuals,lag=16, type="Ljung")
