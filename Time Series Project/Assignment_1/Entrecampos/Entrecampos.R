...
setwd("C:/Users/Fernando/Desktop/ST/Entrecampos")
data <- read_excel("C:/Users/Fernando/Desktop/ST/QualidadeARO3.xlsx")
Localidade <- data$Entrecampos
...
Box.test(test3$residuals,lag=19, type="Ljung")
...
Box.test(test4$residuals,lag=19, type="Ljung")
